...
lvx_file_path = os.path.join(get_package_share_directory('radar_livox_driver'), '../livox/livox_test.lvx')
cmdline_bd_code = 'livox0000000001'

cur_config_path = os.path.join(get_package_share_directory('radar_livox_driver'), 'config')
